...
def app():
    ...
    <style>
    body {
        background: linear-gradient(135deg, #fff7ed 0%, #f4f5ff 100%);
    }
    .stButton>button {
    ...
    if is_streamlit_runtime():
        ...
        st.write("Enter a seed phrase and generate text one character at a time.")
        st.sidebar.header("Text Generation")
        st.sidebar.write("This demo uses a simple RNN to generate character-level text.")
