...
def app():
    ...
    if is_streamlit_runtime():
        ...
        st.write("Upload a 28×28 grayscale image of a handwritten digit for prediction.")
        st.sidebar.header("Digit Classifier")
        st.sidebar.write("This demo uses a one-to-one RNN to classify handwritten digits.")
