...
def app():
    ...
    if is_streamlit_runtime():
        ...
        st.write("Enter an SMS message below, then press Predict to classify it as ham or spam.")
        st.sidebar.header("SMS Spam Detector")
        st.sidebar.write("This demo uses a simple RNN for binary SMS classification.")
